...
# def ok_detail(data=None, msg='ok', data_encoder=True, content_type='application/json;charset=UTF-8',
#               http_status_code=200):
#     if data:
#         for key in data:
...
def blank(msg='no content', data=None, error_code=None, content_type='application/json;charset=UTF-8',
          http_status_code=200):
    return response(msg, False, data, error_code, content_type=content_type, http_status_code=http_status_code)
